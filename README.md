 ...
 * `Integer_*` and `Unsigned_*` type of size 16/32/48/64 in "big-endian" format [`A0B.Types.Big_Endian`](https://github.com/godunko/a0b-base/blob/main/source/a0b-types-big_endian.ads) to use in low level specifications
 ...
 * "Enumerable" modular types of size 2..8 bits, that can be used as array index or in case statements, but doesn't have any arithmetic/bitwise logical operations  in the [`A0B.Types.Enumerable`](https://github.com/godunko/a0b-base/blob/main/source/a0b-types-enumerable.ads) package
